...
(
  ...
  OBJECT_DELETED        INTEGER DEFAULT 0 NOT NULL,
  OBJECT_CLASS          VARCHAR(60) NOT NULL,
  OBJECT_CONTAINER      VARCHAR(32) NOT NULL,
  CONSTRAINT SPSID_OBJECTS_UC01 PRIMARY KEY (OBJECT_ID)
);
...
(
  ...
  CONSTRAINT SPSID_OBJECT_ATTR_UC01 PRIMARY KEY (OBJECT_ID, ATTR_NAME, ATTR_VALUE)
);
...
(
  ...
  APPLICATION           VARCHAR(32) DEFAULT 'SPSID' NOT NULL,
...
CREATE TABLE SPSID_BLOBS
(
  BLOB_ID               VARCHAR(32) NOT NULL,
  BLOB_CONTENT          BLOB NOT NULL,
  CONSTRAINT SPSID_BLOBS_UC01 PRIMARY KEY (BLOB_ID)
);
